...
// accountSettingsCmd represents the accountSettings command
var accountSettingsCmd = &cobra.Command{
	Use:   "settings",
	Short: "Returns the account settings for the currently authenticated user",
	Run: func(cmd *cobra.Command, args []string) {
		res, err := json.MarshalIndent(api.Settings(), "", "  ")
